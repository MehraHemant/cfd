...
export const metadata = {
  title: "BTL Services | Chalti Firti Dukan",
  description: "Generated by create next app",
};

export default function BTLServices() {
  return (
    <>
      <section className="bg-primary py-10 text-white max-md:py-4 max-sm:py-2">
        <div className="flex flex-col items-center gap-2 py-6 max-md:gap-0.5 max-md:py-3 max-sm:gap-0">
        ...
        <div className="mx-auto max-w-xl px-3 text-center text-3xl max-lg:text-xl">
          We deliver{" "}
